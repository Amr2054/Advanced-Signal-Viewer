...
import numpy as np
from config import DATA_PATH ,zip_path
...
class ECGDataLoader:
    ...
    def __init__(self, data_path=zip_path):
        ...
        self.X = self.data['X_test'][0:20,]  # Patient and sample metadata
        self.Y = self.data['Y_test_non_scaled'][0:20,]  # ECG curves (non-scaled)
        self.Z = self.data['Z_test'][0:20,]  # Targets
        self.Y_scaled = self.data['Y_test'][0:20,]  # Scaled ECG curves
