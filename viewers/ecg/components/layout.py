...
#             options=[{"label": f"Patient {i}", "value": i} for i in range(num_records)],
#             value=0,
#             clearable=False,
#             className="mb-3"
#         ),
...
#         # ),
#         html.Div([
#             html.Label("Select View Mode:", style={'fontWeight': 'bold', 'fontSize': '16px', 'marginBottom': '10px'}),
#             dcc.RadioItems(
#                 id='ecg-mode-select',
#                 options=[
#                     {'label': ' 📊 Static (10s)', 'value': 'static'},
...
"""
ECG Viewer Layout - COMPACT & ENHANCED UI
Side-by-side layout for leads and modes
"""
from dash import dcc, html
from viewers.ecg.config import (
    DEFAULT_SELECTED_CHANNELS,
